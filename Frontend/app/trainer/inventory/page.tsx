  ...
  const handleRecord = async () => {
    ...
    try {
      ...
      toast.success(
        ...
        `${form.type} of ${form.qty} recorded`,
      );
      setTxOpen(false);
              ...
              {items.map((i) => (
                <tr
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`text-sm font-semibold ${i.lowStock ? "text-amber-400" : "text-white"}`}>
                      {i.qty}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-sm text-zinc-400">
              ...
              <div
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs">
                    {t.txnType} · by {t.recorderName ?? "user"}
                  </p>
                </div>
      ...
      <Modal
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <LoadingButton loading={loading} onClick={handleRecord}>
              Record
            </LoadingButton>
          </div>
        </div>
