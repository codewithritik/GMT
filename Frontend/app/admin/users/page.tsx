                ...
                <PageHeader
                    ...
                    action={
                        <div className="flex gap-2">
                            <LoadingButton icon={Plus} onClick={() => openAdd(ROLE_OPTIONS.member as Role)} size="md">
                                Add User
                            </LoadingButton>
                            <LoadingButton icon={Plus} onClick={() => openAdd(ROLE_OPTIONS.trainer as Role) } size="md">
                                Add Trainer
                            </LoadingButton>
                        </div>
                    }
