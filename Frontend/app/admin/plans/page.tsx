...
export default function AdminPlansPage() {
  ...
  const toggleActive = async (id: string) => {
    ...
    try {
      ...
      await loadPlans();
      toast.success(
        plan.active ? "Plan Disabled" : "Plan Enabled",
        `${plan.name} has been ${plan.active ? "disabled" : "enabled"}`,
      );
    } catch (err) {
      toast.error("Error", getErrorMessage(err));
    }
          ...
          <Card
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="text-right">
                ...
                <p className="text-zinc-500 text-xs">
                  / {plan.durationDays >= 360 ? "year" : "month"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => {
                    toggleActive(plan.id).catch(() => undefined);
                  }}
      ...
      {plans.length === 0 && (
        <Card padding="md">
          <p className="text-zinc-500 text-sm text-center">
            {pageLoading ? "Loading plans..." : "No plans found."}
          </p>
        </Card>
      )}
        ...
        <div className="space-y-4">
          ...
          <Select
            ...
            onChange={(e) =>
              setFormData((prev) => ({
                ...prev,
                billing: e.target.value as "monthly" | "annual",
              }))
            }
          />
          {!editingPlan && (
