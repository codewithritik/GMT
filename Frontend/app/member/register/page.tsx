...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      norm(phone) &&
      norm(emergencyPhone) &&
      norm(phone) === norm(emergencyPhone)
    ) {
    ...
    try {
      const response = await authAPI.register({
        ...
        phone,
        gender:
          (gender as "male" | "female" | "other" | undefined) || undefined,
        emergencyName,
        emergencyPhone,
        emergencyRelation,
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center p-6 py-12 overflow-y-auto">
        ...
        <div className="w-full max-w-xl text-center mb-10">
          ...
          <p className="text-lg text-zinc-400">
            Join our community. Premium facilities and expert coaching.
          </p>
        </div>

        {/* Form card — horizontal-friendly, left-aligned */}
        <div
          className="w-full max-w-2xl bg-zinc-800/80 backdrop-blur-xl border border-zinc-700 p-8 rounded-3xl shadow-2xl"
          id="register-card">
          <div className="mb-6">
            <h2 className="text-2xl font-bold mb-2" id="register-title">
              Create Account
            </h2>
            <p className="text-zinc-400 text-sm">
              Fill the form below, fields marked with asterisk (*) are
              mandatory.
            </p>
          </div>
          ...
          <form
            ...
            <section className="space-y-4" aria-labelledby="section-basic">
              <h3
                id="section-basic"
                className="text-sm font-semibold text-zinc-300 tracking-wider">
                Basic Information
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <User
                      className="absolute left-3 top-3.5 text-zinc-500 group-focus-within:text-red-500 transition-colors pointer-events-none"
                      size={18}
                    />
                    <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 relative">
                  ...
                  {passwordFocused && (
                    <div
                      className="absolute top-full left-0 mt-2 w-full p-4 bg-zinc-900 border border-zinc-800 rounded-xl shadow-xl z-50"
                          ...
                          <li
                            ...
                            <div
                              className={cn(
                                ...
                                req.valid ? "bg-green-400" : "bg-zinc-700",
                              )}
                            />
                            {req.label}
                          </li>
            ...
            <section
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <label
                    htmlFor="register-emergency-name"
                    className="block text-sm font-medium text-zinc-300">
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="register-emergency-phone"
                    className="block text-sm font-medium text-zinc-300">
                    Phone <span className="text-red-500">*</span>
                  </label>
                  <input
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="register-emergency-relation"
                    className="block text-sm font-medium text-zinc-300">
                    Relationship
                  </label>
                  <input
            ...
            <section
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="relative group">
                    ...
                    <select
                      ...
                      {["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"].map(
                        (bt) => (
                          <option key={bt} value={bt} className="bg-zinc-900">
                            {bt}
                          </option>
                        ),
                      )}
                ...
                <div className="space-y-2 md:col-span-2">
                  <label
                    htmlFor="register-medical-conditions"
                    className="block text-sm font-medium text-zinc-300">
                    Medical conditions
                  </label>
                  <input
