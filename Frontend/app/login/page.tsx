...
function LoginForm() {
  ...
  const roleForUi: Role | null = (
    ["member", "trainer", "manager", "admin"] as const
  ).includes(roleFromQuery as Role)
  ...
  return (
    <div className="min-h-screen bg-app text-white flex relative overflow-hidden selection:bg-red-600/30">
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center p-6 py-12">
        ...
        <div className="w-full max-w-xl text-center mb-10">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 leading-tight">
            {roleForUi ? (
              ...
              <>
                Welcome back to{" "}
                <span className="text-red-500">Elite Fitness.</span>
              </>
            )}
          </h1>
        ...
        <div
          className="w-full max-w-md bg-zinc-800/80 backdrop-blur-xl border border-zinc-700 p-8 rounded-3xl shadow-2xl"
          id="login-card">
          <div className="mb-8">
