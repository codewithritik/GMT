...
async function seed() {
  ...
  const planRows = await db
    .select({ id: subscriptionPlans.id, planCode: subscriptionPlans.planCode, price: subscriptionPlans.price, durationValue: subscriptionPlans.durationValue, name: subscriptionPlans.name })
    .from(subscriptionPlans)
